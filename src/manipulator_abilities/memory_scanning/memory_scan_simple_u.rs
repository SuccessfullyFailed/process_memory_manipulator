#[cfg(test)]
mod tests {
	use crate::{ MemoryDataType, MemoryScanResult, ProcessMemoryManipulator, ProcessMemoryManipulator64, active_process_name, scan_value_modification_sleep };
	...
	fn test_memory_simple_scan_types() {
		...
		hidden_value = (i8::random() as i32).clone();
		println!("{}", hidden_value);
		scan_value_modification_sleep();
